 ...
 */
export type Sukura = {
    address: '4DEyCcKWoS4MEPHwC3b8YxgJoXVnfsEJ6WmVRhNCXJQ4'
    metadata: {
        name: 'sukura'
        version: '0.1.0'
        spec: '0.1.0'
    ...
    instructions: [
        {
            ...
            accounts: [
                {
                    name: 'pool'
                    docs: ['The pool account that manages deposits and withdrawals.']
                    writable: true
                },
                {
                    name: 'vault'
                    docs: ['The vault account that stores deposited funds.']
                    writable: true
                    relations: ['pool']
                },
                {
                    name: 'sender'
                    docs: ['The sender account that initiates the deposit transaction.']
                    writable: true
                    signer: true
                },
                {
                    name: 'poolSigner'
                    docs: ['The pool signer account, which authorizes transactions.']
                    pda: {
                        seeds: [
                            {
                                kind: 'account'
                ...
                {
                    name: 'systemProgram'
                    docs: ['The system program required for fund transfers.']
        ...
        },
        {
            ...
            accounts: [
                ...
                },
                {
                    ...
                    docs: ['The global authority account that stores the only allowed initializer.']
                    writable: true
                    pda: {
                        seeds: [
                            {
        ...
        },
        {
            ...
            accounts: [
                {
                    name: 'pool'
                    docs: ['The pool account managing the Merkle tree and funds.']
                    writable: true
                },
                {
                    name: 'vault'
                ...
                {
                    name: 'systemProgram'
                    docs: ['System program required for executing transfers.']
                    address: '11111111111111111111111111111111'
                },
            ]
            args: [
    ...
    accounts: [
        {
            name: 'globalAuthority'
            discriminator: [251, 185, 159, 84, 23, 33, 205, 72]
        },
        {
            name: 'sukura'
    ...
    types: [
        ...
        },
        {
            ...
            docs: ['A struct representing a Merkle Tree with history for storing commitments.']
            type: {
                kind: 'struct'
                fields: [
                    {
                        name: 'levels'
                        docs: ['The depth of the Merkle tree (number of levels).']
                        type: 'u32'
                    },
                    {
                        name: 'filledSubtrees'
                        docs: ['Stores intermediate hashes of subtree roots at each level.']
                        type: {
                            vec: {
                                array: ['u8', 32]
                            }
                    ...
                    {
                        name: 'roots'
                        docs: ['Stores the historical Merkle roots.']
                        type: {
                            vec: {
                                array: ['u8', 32]
                            }
                    ...
                    },
                    {
                        ...
                        docs: ['Tracks the index of the current Merkle root.']
                        type: 'u64'
                    },
                    {
                        name: 'nextIndex'
                        docs: ['Tracks the next available index for inserting a new leaf.']
                        type: 'u32'
                    },
                    {
                        name: 'zeros'
                        docs: ['Precomputed zero hashes for empty nodes at each level.']
                        type: {
                            vec: {
                                array: ['u8', 32]
                            }
        ...
        },
        {
            ...
            type: {
                ...
                fields: [
                    {
                        name: 'merkleTree'
                        docs: ['The Merkle tree used to store commitments as leaves.']
                        type: {
                            defined: {
                                name: 'merkleTreeWithHistory'
                            }
                    ...
                    {
                        name: 'nonce'
                        docs: ['A nonce used to uniquely identify different pools.']
                        type: 'u8'
                    },
                    {
                        name: 'vault'
                        docs: ['The public key of the vault where funds are stored.']
                        type: 'pubkey'
                    },
                ]
            }
